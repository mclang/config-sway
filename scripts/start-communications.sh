...
nohup /var/lib/flatpak/exports/bin/com.slack.Slack        --enable-features=UseOzonePlatform > /dev/null 2>&1 &
nohup /var/lib/flatpak/exports/bin/com.discordapp.Discord --enable-features=UseOzonePlatform --ozone-platform=wayland > /dev/null 2>&1 &
nohup /usr/bin/signal-desktop --use-tray-icon             --enable-features=UseOzonePlatform --ozone-platform=wayland > /dev/null 2>&1 &
